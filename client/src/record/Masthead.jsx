...
export default function Masthead({
  ...
  return (
    <div className="ncr-band" style={{ position: 'relative', zIndex: 30, borderBottom: '1px solid var(--ncr-ink)' }}>
      <div style={{ maxWidth: 1340, margin: '0 auto', padding: '22px 40px 16px' }}>
